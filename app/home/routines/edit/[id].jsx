...
import { ActivityIndicator, Button, Dialog, Divider, IconButton, Modal, PaperProvider, Portal, Text, TextInput } from 'react-native-paper';
...
const EditScreen = () => {
    ...
    const [routineError, routine, routineLoading] = useRoutine(id, true);
    ...
    async function handleEditRoutine() {
        ...
        try {
            ...
            await editRoutine(id, routineName, exercises);
        ...
        return (
            <View style={{ backgroundColor: "white", height: "100%", paddingHorizontal: 10 }}>
                <View style={styles.Header}>
                    ...
                    <Text variant='headlineMedium' style={{ marginRight: 'auto' }}>Editar rutina</Text>
                </View>
    ...
    return (
        <PaperProvider>
            ...
            <View style={{ backgroundColor: "white", height: "100%", paddingHorizontal: 10 }}>
                ...
                {routineLoading && <ActivityIndicator color='#FF7F3E' style={{ marginVertical: 50 }} animating={true} size={60} />}
                {!routineLoading && exercises.length > 0
                    ? (
                ...
                <Portal>
                    <Dialog visible={isConfirming} onDismiss={() => setIsConfirming(false)} style={{ backgroundColor: 'white' }}>
                        <Dialog.Title>Confirmas editar la rutina?</Dialog.Title>
                        <Dialog.ScrollArea>
                            <Dialog.Content>
                                <Text variant="bodyMedium" style={{ marginBottom: 8 }}>Cambiar el nombre a la rutina:</Text>
                        ...
                        <Dialog.Actions>
                            ...
                            <Button onPress={handleEditRoutine} loading={editingLoading} mode='contained' buttonColor='#FF7F3E' style={{ paddingHorizontal: 5 }} textColor='white'>Guardar</Button>
                        </Dialog.Actions>
                    </Dialog>
                </Portal>
